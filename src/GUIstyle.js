export class GuiStyler {
    ...
    static styleExistingFolders(gui) {
        gui.folders.forEach((folder) => {
            ...
            switch (folderTitle) {
                case "Spotlight 1":
                    GuiStyler.applyStyleRecursively(folder, "#C6E2FF", "#A8D4FF", "#232A3E", "#121A28"); // 柔和的清爽淡蓝
                    break;
                case "Spotlight 2":
                    GuiStyler.applyStyleRecursively(folder, "#C6FFF1", "#A8FFE4", "#233A3A", "#121E1E"); // 柔和的淡薄荷绿
                    break;
                case "Model":
                    GuiStyler.applyStyleRecursively(folder, "#D1DEFF", "#B3C8FF", "#242C3F", "#131822"); // 淡雅的柔紫蓝
                    break;
                case "Subsurface Scattering":
                    GuiStyler.applyStyleRecursively(folder, "#C6EEFF", "#A8E4FF", "#233340", "#121B26"); // 清淡的浅天蓝
                    break;
                default:
